...
import * as Plugin_0 from '/Users/qiuxue/Desktop/project/react-learn/src/app.ts';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/qiuxue/Desktop/project/react-learn/src/app.ts',
    },
    {
      apply: Plugin_1,
